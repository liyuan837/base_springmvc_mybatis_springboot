...
import com.liyuan.demo.entity.qiniu.QiNiuProperties;
import com.liyuan.demo.service.QiNiuService;
...
public class QiNiuServiceImpl implements QiNiuService, InitializingBean {
    ...
    public Response uploadFile(File file) throws QiniuException {
        Response response = this.uploadManager.put(file, "badges.zip", getUploadToken());
        int retry = 0;
